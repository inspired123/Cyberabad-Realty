...
<section style="padding:0px 0px 178px 0px;">

  <div class="swiper-container slideshow">

    <div class="swiper-wrapper">

      @foreach($farmlandslides as $farm)
      <div class="swiper-slide slide">
        <div class="slide-image" style="background-image: url('public/{{ $farm->logo}}');"></div>
        <span class="slide-title"style="font-size:35px;">{{$farm->title}}</span>
      ...
      @endforeach
      <!--<div class="swiper-slide slide">-->
      <!--  <div class="slide-image" style="background-image: url(https://www.abmrealtyltd.com/wp-content/uploads/2019/03/house1.jpg"></div>-->
...
<section class="space-pb">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-8" style="margin:-200px 0px 0px 0px;">
        <div class="section-title text-center">
          <h2>Farm properties</h2>
          <p>Find your dream home from our Newly added properties</p>
        </div>
...
load_data21('', _token);
  ...
  function load_data(id="", _token, country)
 {
  ...
  function load_data21(id="", _token, country)
 {

  $.ajax({
   url:'{{url("farmland-properties")}}',
   method:"POST",
   data:{id:id, _token:_token},
   success:function(data)
   {
    $('#remove-row21').remove();
    $('#load-data21').append(data);
   }
  })
 }
 
   $(document).on('click', '#btn-more21', function(){
  var id = $(this).data('id');

  
  $('#btn-more21').html('<b>Loading...</b>');
  load_data21(id, _token);
 });
