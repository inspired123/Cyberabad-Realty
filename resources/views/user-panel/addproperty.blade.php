...
$('#available_from-error').text('');
	...
	&& rm_transaction_type !== '' && possession_date !== '' && uc_transaction_type !== '') {
...
$('#uc_transaction_type-error').text('');
	...
	&& carpet_area !== '' && carpet_area_measurement !== '' && buildup_area !== '' && buildup_area_measurement !== '' && additional_rooms_checkbox !==0
	&& sale_price !== '' && sale_price_measurement !== '' && sale_negotiatible !== '' && sale_booking_amount !== ''	
	&& include_price_checkbox !==0 && property_status !== '' && possession_date !== '' && uc_transaction_type !== '') {
...
$(document).ready(function (e) {
        ...
        $('#msform').submit(function(e) {
            ...
            $.ajax({
                type:'POST',
                url: "{{ url('user-panel/user_add_property')}}",
                data: formData,
                cache:false,
                contentType: false,
                processData: false,
