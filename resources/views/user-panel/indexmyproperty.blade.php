...
<body>
  ...
  <!--          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 mb-4">-->
		...
		<!--				<div class="feature-pic set-bg" style="height:190px;"data-setbg="{{url('/')}}/usercss/images/sumadhura-horizon-3164-s2.jpg">-->
		<!--					<div class="sale-notic">FOR SALE</div>-->
		<!--				</div>-->
		<!--				<div class="feature-text" style="padding:-10px;">-->
		<!--					<div class="text-center feature-title">-->
							
		<!--							<a href="single-list.html">28 Quaker Ridge Road, Manhasset</a>-->
		<!--						<p><i class="fa fa-map-marker"></i> Bachupalli</p>-->
		<!--					</div>-->
		<!--					<div class="room-info-warp" style="padding-top:5px;">-->
		<!--						<div class="room-info">-->
		<!--							<div class="rf-left">-->
		...
		<!--						</div>-->
		<!--					</div>-->
		<!--					<div class="row-status" style="background-color:#30caa0;">-->
		<!--					<button type="button" style="margin: 9px 0px 4px 17px; background-color:#30caa0;"class="btn active"><i class="fa fa-edit" aria-hidden="true"></i>Edit</button>-->
		<!--					<button type="button" style="margin: 9px 0px 4px 125px; background-color:#30caa0;" class="btn">Status</button>-->
		...
		<!--			<div class="feature-item">-->
		<!--				<div class="feature-pic set-bg" style="height:190px;"data-setbg="{{url('/')}}/usercss/images/sumadhura-horizon-3164-s2.jpg">-->
		<!--					<div class="sale-notic">FOR LEASE</div>-->
		<!--				</div>-->
		<!--				<div class="feature-text" style="padding:-10px;">-->
		<!--					<div class="text-center feature-title">-->
...
load_data31('', _token);
 ...
 function load_data31(id="", _token)
 {
  ...
  $.ajax({
   ...
   {
    $('#remove-row31').remove();
    $('#load-data31').append(data);
   }
  })
 }
 
  $(document).on('click', '#btn-more31', function(){
  var id = $(this).data('id');

  
  $('#btn-more31').html('<b>Loading...</b>');
  load_data31(id, _token);
 });
});
