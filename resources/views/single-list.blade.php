...
<div class="sl-item set-bg" data-setbg="{{url('/public')}}/{{ $property->image_file}}">
...
@foreach (explode(',', $property->multi_images) as $image)

<div class="sl-thumb set-bg" data-setbg="{{url('/')}}/public/uploads/{{$image}}"></div>
@endforeach
</div>
...
<p><i class="fa fa-user"></i>bedrooms : {{ $property->bedrooms }}</p>
...
@elseif($property->property_type == "farmhouse")
<div class="col-md-4 col-sm-6">
<p><i class="fa fa-user"></i>{{$property->balconies}}</p>
<p><i class="fa fa-envelope"></i>email</p>
<p><i class="fa fa-clock-o"></i> year</p>
</div>
<div class="col-md-4 col-sm-6">
...
<input type="hidden" id="property_id"  name="property_id" placeholder="Your name" value="{{Request::segment(2)}}">
