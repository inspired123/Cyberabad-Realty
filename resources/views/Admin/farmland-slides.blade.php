    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                Slides
			<a href="{{url('/')}}/farmland-add-slides"><span class="badge bg-danger float-right" style="padding:12px;"><i class="fa fa-plus"></i>Add farmland Slides</span></a>
                ...
                <table class='table table-striped' id="table1">
                    ...
                    <tbody>
                        ...
                        <tr id="row{{$farm->id}}">
                            ...
                            <td>{{$farm->title}}</td>
							<td><img src="{{url('/public/')}}/{{$farm->logo}}" style="width:50px; height:50px;"></td>
