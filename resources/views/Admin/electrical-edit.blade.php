...
<link rel="stylesheet" href="{{url('/')}}/assets/vendors/simple-datatables/style.css">
    ...
    <link rel="stylesheet" href="{{url('/')}}/css2/plugins.css">
...
<div class="row">
<form action="{{url('sales_submit')}}" id="edituser" method="post">
	{{ csrf_field() }}
...
<div class="form-row">
    <div class="form-group col-md-3">
	  ...
	  <input type="text" id="name" name="name" class="form-control" id="inputCity"value="{{$sales->name}}">
	  <strong id="name-error"></strong>
	</div>
	  
	 <div class="form-group col-md-3">
      <label for="inputPassword4"style="color:black;">Enterprise name</label>
	  <input type="text" id="enterprise_name" name="enterprise_name" class="form-control" id="inputCity"value="{{$sales->enterprise_name}}">
	  <strong id="enterprise_name-error"></strong>
	</div>
	  
	 <div class="form-group col-md-3">
      <label for="inputPassword4"style="color:black;">Phone </label>
	  <input type="text" id="phone" name="phone" class="form-control" placeholder="+91 9876543210" id="inputCity"value="{{$sales->phone}}">
	  <strong id="phone-error"></strong>
	</div>
	<div class="form-group col-md-3">
      <label for="inputPassword4"style="color:black;">Email </label>
	  <input type="text" id="mail" name="mail" class="form-control" placeholder="example@gmail.com" id="inputCity"value="{{$sales->mail}}">
...
">
            <div class="btn btn-default browse-button">
                ...
                <input type="file" id="licence_document" name="licence_document" value="{{$sales->licence_document}}" accept=".pdf" name="attachment"/>
    ...
    border: 1px solid #c4c8cc;">
            <div class="btn btn-default browse-button">
                <span class="browse-button-text">
                <i class="fa fa-folder-open"></i> Browse</span>
                <input type="file" id="material_rate_chart" value="{{$sales->material_rate_chart}}" name="material_rate_chart" accept=".pdf" name="attachment"/>
	...
	<div class="form-group col-md-6">
	  ...
	  <input type="text" id="branch" name="branch" class="form-control"value="{{$sales->branch}}">
...
<div class="form-row" id="repair_1" style="display:none">
      ...
      <input type="text" id="exp" name="exp" class="form-control"value="{{$sales->exp}}">
	  <strong id="exp-error"></strong>
    </div>
	<div class="form-group col-md-6">
      <label for="inputPassword4"style="color:black;">service areas</label>
	  <input type="text" id="service" name="service" class="form-control"value="{{$sales->service}}">
...
">
                                                    ...
                                                    <input id="plan-img" id="logo" name="logo" value="{{$sales->logo}}" type="file" multiple>
...
<div class="form-row">
    <div class="form-group col-md-3">
	  ...
	  <input type="text" id="address" name="address" class="form-control" id="inputCity" value="{{$sales->address}}">
	 ...
	 <div class="form-group col-md-3">
	  ...
	  <select id="inputState" id="year" name="year" class="form-control"value="{{$sales->year}}">
	...
	<div class="form-group col-md-3">
	  ...
	  <input type="text" id="websitelink" name="websitelink" class="form-control" placeholder="cyberabad realty.com" id="inputCity"value="{{$sales->websitelink}}">
