...
<div class="form-row">
	<div class="form-group col-md-4">
      ...
      <select id="inputState" class="form-control" placeholder="Select location">
        <option selected>Property location</option>
		<option>Hyd</option>
        <option>Hyd</option>
    ...
    <div class="form-group col-md-2">
	  <input type="text" class="form-control" id="inputCity"placeholder="Landmark">
	</div><br>
	...
	<div class="form-group col-md-4">
      ...
      <select id="inputState" class="form-control" placeholder="Select location">
		...
		<option>Farm Land/Agri Land</option>
...
<div class="form-row">
    <div class="form-group col-md-2">
	 ...
	 <div class="form-group col-md-4">
      ...
      <select id="inputState" class="form-control">
        <option selected>Select soil</option>
		<option>1</option>
        <option>2</option>
		<option>3</option>
		<option>4</option>
...
<div class="container">
	...
	<div class="form-group col-md-12">
      <label for="inputPassword4"style="color:black;">Property dimensions</label>
	 </div>
	 </div>
	 <div class="form-row">
	 <div class="form-group col-md-4">
      <label for="inputPassword4"style="color:black;">length of plot(in yards)</label>
	  <input type="text" class="form-control" id="inputCity">
	</div>
	  
	 <div class="form-group col-md-4">
      <label for="inputPassword4"style="color:black;">Breadth of plot(in yards)</label>
	  <input type="text" class="form-control" id="inputCity">
	</div>
...
<div class="container">
	<div class="form-row">
    <div class="form-group col-md-12">
      <label for="inputPassword4"style="color:black;">Water source</label>
	 </div>
	 </div>
	 <div class="form-row">
...
<div class="container">
	...
	<div class="form-group col-md-12">
	 ...
	 <div class="form-row">
	 <div class="form-group col-md-4">
      <label for="inputState">Is there a boundary wall about property</label>
      <select id="inputState" class="form-control">
