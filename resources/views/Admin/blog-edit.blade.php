                ...
                <div class="form-body">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group has-icon-left">
                                <div class="position-relative">
                                    <input type="text" id="name9" name="name9" class="form-control" placeholder="Name" id="first-name-icon"value="{{$blog->name}}">
									
                                <strong id="name9-error"></strong>
                        ...
                        <div class="col-md-8">
                            <div class="form-group has-icon-left">
                                <div class="position-relative">
                                    <input type="title" id="title9" name="title9" class="form-control" placeholder="Title" id="first-name-icon"value="{{$blog->title}}">
									
                                <strong id="title9-error"></strong>
                                    <div class="form-control-icon">
...
<input type="file" class="form-control" id="logo9" name="logo9"value="{{ $blog->logo }}">
                        ...
                        <div class="col-md-8">
                            <div class="form-group has-icon-left">
                                <div class="position-relative">
									<div id="description9" name="description9" class="card-body"style="padding:4px;"value="{{ $blog->logo }}">
									<strong id="description9-error"></strong>
									<div id="full">
 ...
 $('#edituser').on('submit', function(e){
   ...
   processData: false,
                success: function(data) {
                    ...
                    if(data.errors.name){
                        $( '#name9-error' ).html( data.errors.name[0] );
                    }
                    if(data.errors.title){
                        $( '#title9-error' ).html( data.errors.title[0] );
                    }
					if(data.errors.title){
                        $( '#description9-error' ).html( data.errors.title[0] );
                    }
