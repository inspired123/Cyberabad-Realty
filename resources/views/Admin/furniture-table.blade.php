    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                Electrical
			<a href="{{url('/')}}/furniture"><span class="badge bg-danger float-right" style="padding:8px; border-radius: 10px !important;"><i class="fa fa-plus"></i><b>Add Electrical</b></span></a>
<p id="success"></p>
            </div>
            <div class="card-body">
